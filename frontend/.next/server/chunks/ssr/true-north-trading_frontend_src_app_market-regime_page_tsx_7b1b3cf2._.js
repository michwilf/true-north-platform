...
function MarketRegimePage() {
    ...
    const loadRegimeData = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await fetch("http://localhost:8002/api/market-regime/detailed");
...
//# sourceMappingURL=true-north-trading_frontend_src_app_market-regime_page_tsx_7b1b3cf2._.js.map