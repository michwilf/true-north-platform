...
function Dashboard() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$true$2d$north$2d$trading$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                    ...
                    children: [
                        {
                            ...
                            change: metricsLoading ? "..." : `${(portfolioMetrics?.daily_pnl_percent ?? 0) >= 0 ? "+" : ""}${(portfolioMetrics?.daily_pnl_percent ?? 0).toFixed(2)}%`,
                            positive: (portfolioMetrics?.daily_pnl_percent ?? 0) >= 0
                        },
                        {
                            title: "Daily P&L",
                            value: metricsLoading ? "Loading..." : `${(portfolioMetrics?.daily_pnl ?? 0) >= 0 ? "+" : ""}$${(portfolioMetrics?.daily_pnl ?? 0).toLocaleString()}`,
                            change: metricsLoading ? "..." : `${(portfolioMetrics?.daily_pnl_percent ?? 0) >= 0 ? "+" : ""}${(portfolioMetrics?.daily_pnl_percent ?? 0).toFixed(2)}%`,
...
//# sourceMappingURL=true-north-trading_frontend_src_d98306f1._.js.map