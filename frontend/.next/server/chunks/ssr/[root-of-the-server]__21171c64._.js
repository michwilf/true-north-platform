        ...
        try {
            ...
            eventSource.onmessage = (event)=>{
                try {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`3091280164_156_10_156_56_4`, `[${symbol}] Stream event:`, data));
                    // Handle REAL-TIME TEXT STREAMING from agents
                    if (data.event === "agent_text_start") {
                        /* eslint-disable */ console.log(...oo_oo(`3091280164_160_12_160_76_4`, `[${symbol}] 🚀 ${data.agent} starting to write...`));
                        setAgentTexts((prev)=>({
                                ...prev,
                                [symbol]: {
                                    ...prev[symbol],
                        ...
                        /* eslint-disable */ console.log(...oo_oo(`3091280164_170_12_170_70_4`, `[${symbol}] 📝 ${data.agent}: ${data.chunk}`));
                        setAgentTexts((prev)=>({
                                ...prev,
                                [symbol]: {
                                    ...prev[symbol],
                        ...
                        /* eslint-disable */ console.log(...oo_oo(`3091280164_179_12_179_71_4`, `[${symbol}] ✅ ${data.agent} finished writing`));
                    }
                    ...
                    if (data.event === "start") {
                        ...
                        // Analysis complete
                        /* eslint-disable */ console.log(...oo_oo(`3091280164_217_12_217_63_4`, `[${symbol}] Analysis complete!`, data));
                        ...
                        /* eslint-disable */ console.error(...oo_tx(`3091280164_226_12_226_70_11`, `[${symbol}] Analysis error:`, data.message));
                        setLoadingAnalysis((prev)=>({
                                ...prev,
                                [symbol]: false
                            }));
            ...
            eventSource.onerror = (error)=>{
                /* eslint-disable */ console.error(...oo_tx(`3091280164_236_8_236_59_11`, `Stream error for ${symbol}:`, error));
                setLoadingAnalysis((prev)=>({
                        ...prev,
                        [symbol]: false
                    }));
            ...
            /* eslint-disable */ console.error(...oo_tx(`3091280164_245_6_245_68_11`, `Failed to load analysis for ${symbol}:`, error));
            setLoadingAnalysis({
                ...loadingAnalysis,
                [symbol]: false
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21171c64._.js.map