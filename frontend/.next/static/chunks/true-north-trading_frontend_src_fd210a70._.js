...
function OpportunitiesPage() {
    ...
    const loadDetailedAnalysis = async (symbol)=>{
        ...
        try {
            const response = await fetch("http://localhost:8002/api/analyze-stock/".concat(symbol), {
                method: "POST"
            });
            ...
            console.error("Failed to load analysis for ".concat(symbol, ":"), error);
        } finally{
            setLoadingAnalysis({
                ...loadingAnalysis,
                [symbol]: false
...
_s(OpportunitiesPage, "uL063Nq2DTauqphRnd5obHmBMp4=", false, function() {
    return [
