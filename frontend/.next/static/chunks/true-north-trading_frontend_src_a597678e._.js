        ...
        try {
            ...
            eventSource.onmessage = (event)=>{
                try {
                    ...
                    /* eslint-disable */ console.log(...oo_oo("3091280164_156_10_156_56_4", "[".concat(symbol, "] Stream event:"), data));
                    // Handle REAL-TIME TEXT STREAMING from agents
                    if (data.event === "agent_text_start") {
                        /* eslint-disable */ console.log(...oo_oo("3091280164_160_12_160_76_4", "[".concat(symbol, "] 🚀 ").concat(data.agent, " starting to write...")));
                        setAgentTexts((prev)=>({
                                ...prev,
                                [symbol]: {
                                    ...prev[symbol],
                        ...
                        /* eslint-disable */ console.log(...oo_oo("3091280164_170_12_170_70_4", "[".concat(symbol, "] 📝 ").concat(data.agent, ": ").concat(data.chunk)));
                        setAgentTexts((prev)=>{
                            var _prev_symbol;
                            return {
                                ...prev,
                        ...
                        /* eslint-disable */ console.log(...oo_oo("3091280164_179_12_179_71_4", "[".concat(symbol, "] ✅ ").concat(data.agent, " finished writing")));
                    }
                    ...
                    if (data.event === "start") {
                        ...
                        // Analysis complete
                        /* eslint-disable */ console.log(...oo_oo("3091280164_217_12_217_63_4", "[".concat(symbol, "] Analysis complete!"), data));
                        ...
                        /* eslint-disable */ console.error(...oo_tx("3091280164_226_12_226_70_11", "[".concat(symbol, "] Analysis error:"), data.message));
                        setLoadingAnalysis((prev)=>({
                                ...prev,
                                [symbol]: false
                            }));
                    ...
                    /* eslint-disable */ console.error(...oo_tx("3091280164_231_10_231_53_11", "Error parsing stream:", err));
                }
            };
            eventSource.onerror = (error)=>{
                /* eslint-disable */ console.error(...oo_tx("3091280164_236_8_236_59_11", "Stream error for ".concat(symbol, ":"), error));
                setLoadingAnalysis((prev)=>({
                        ...prev,
                        [symbol]: false
                    }));
            ...
            /* eslint-disable */ console.error(...oo_tx("3091280164_245_6_245_68_11", "Failed to load analysis for ".concat(symbol, ":"), error));
            setLoadingAnalysis({
                ...loadingAnalysis,
                [symbol]: false
            });
...
//# sourceMappingURL=true-north-trading_frontend_src_a597678e._.js.map