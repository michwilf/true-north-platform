...
function OpportunitiesPage() {
    var _analysisProgress_drawerSymbol, _analysisProgress_drawerSymbol1;
    _s();
    ...
    const loadDetailedAnalysis = async (symbol)=>{
        ...
        try {
            ...
            const eventSource = new EventSource("".concat(API_URL, "/api/analyze-stock-stream-text/").concat(symbol));
            eventSource.onmessage = (event)=>{
                try {
                    const data = JSON.parse(event.data);
                    /* eslint-disable */ console.log(...oo_oo("4016983425_157_10_157_56_4", "[".concat(symbol, "] Stream event:"), data));
                    // Handle REAL-TIME TEXT STREAMING from agents
                    if (data.event === "agent_text_start") {
                        /* eslint-disable */ console.log(...oo_oo("4016983425_161_12_161_76_4", "[".concat(symbol, "] 🚀 ").concat(data.agent, " starting to write...")));
                        setAgentTexts((prev)=>({
                                ...prev,
                                [symbol]: {
                                    ...prev[symbol],
                        ...
                        /* eslint-disable */ console.log(...oo_oo("4016983425_171_12_171_70_4", "[".concat(symbol, "] 📝 ").concat(data.agent, ": ").concat(data.chunk)));
                        setAgentTexts((prev)=>{
                            var _prev_symbol;
                            return {
                                ...prev,
                                [symbol]: {
                                    ...prev[symbol],
                                    [data.agent]: (((_prev_symbol = prev[symbol]) === null || _prev_symbol === void 0 ? void 0 : _prev_symbol[data.agent]) || "") + data.chunk
                                }
                            };
                        });
                    } else if (data.event === "agent_text_complete") {
                        /* eslint-disable */ console.log(...oo_oo("4016983425_180_12_180_71_4", "[".concat(symbol, "] ✅ ").concat(data.agent, " finished writing")));
                    }
                    ...
                    if (data.event === "start") {
                        ...
                        setAnalysisProgress((prev)=>({
                                ...prev,
                                [symbol]: {
                                    currentAgent: "Running ".concat(data.agent, "..."),
                        ...
                        setAnalysisProgress((prev)=>({
                                ...prev,
                                [symbol]: {
                                    currentAgent: "✓ ".concat(data.agent, " complete"),
                                    progress: data.progress || 0
                                }
                            }));
                        ...
                        // Analysis complete
                        /* eslint-disable */ console.log(...oo_oo("4016983425_218_12_218_63_4", "[".concat(symbol, "] Analysis complete!"), data));
                        ...
                        /* eslint-disable */ console.error(...oo_tx("4016983425_227_12_227_70_11", "[".concat(symbol, "] Analysis error:"), data.message));
                        setLoadingAnalysis((prev)=>({
                                ...prev,
                                [symbol]: false
                            }));
            ...
            eventSource.onerror = (error)=>{
                /* eslint-disable */ console.error(...oo_tx("4016983425_237_8_237_59_11", "Stream error for ".concat(symbol, ":"), error));
                setLoadingAnalysis((prev)=>({
                        ...prev,
                        [symbol]: false
                    }));
            ...
            /* eslint-disable */ console.error(...oo_tx("4016983425_246_6_246_68_11", "Failed to load analysis for ".concat(symbol, ":"), error));
            setLoadingAnalysis({
                ...loadingAnalysis,
                [symbol]: false
            });
...
//# sourceMappingURL=true-north-trading_frontend_src_8c7338a7._.js.map